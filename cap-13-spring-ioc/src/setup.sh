...
sudo mysql -u test --password="123456" -e "insert into usuarios(login, senha) values('test', '123456');" fj21;

# Para mostrar o banco de dados:
#mysql -u test --password="123456" -e "select * from contatos;" fj21;
#mysql -u test --password="123456" -e "select * from tarefas;" fj21;
#mysql -u test --password="123456" -e "select * from usuarios;" fj21;
